...
def stepper(space,swing,robot_u,seat_motor,knee_motor,l_leg,u_leg,action):
    ...
    body_angle = robot_u.angle - swing.angle
    leg_angle = l_leg.angle - swing.angle

    return [angle, ang_vel],[space,swing,robot_u,seat_motor,knee_motor,l_leg,u_leg],body_angle,leg_angle
...
def stepper_display(space,swing,robot_u,seat_motor,knee_motor,l_leg,u_leg,screen,draw_options,clock,font,action):
    ...
    return [angle, vel[0], vel[1]],[space,swing,robot_u,seat_motor,knee_motor,l_leg,u_leg,screen,draw_options,clock,font]
