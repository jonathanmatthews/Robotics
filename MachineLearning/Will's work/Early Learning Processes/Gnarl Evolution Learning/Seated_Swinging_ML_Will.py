...
def initialise():
    ...
    return [space,swing,robot_u,seat_motor,knee_motor]

def stepper(space,swing,robot_u,seat_motor,knee_motor,action):
    if action == 2:
        seat_motor.rate = 3
        knee_motor.rate = 6
    elif action == 1:
    ...
    return [angle, vel[0], vel[1], body_pos],[space,swing,robot_u,seat_motor,knee_motor]
