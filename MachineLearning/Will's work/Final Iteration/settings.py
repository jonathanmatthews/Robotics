...
max_steps_long_run = 40000#60000 until 120
save_rate = 1
certain_parents = int(0.25*number_nets)
random_parents = int((number_nets/2)-certain_parents)
max_fitness_self_start = max_steps_self_start*4.3
max_fitness_pre_start = max_steps_pre_start*4.3
