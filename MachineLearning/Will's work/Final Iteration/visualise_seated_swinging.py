...
env = SSwingEnv.initialise_display(True)
...
r = 0
try:
    for t in range(settings.max_steps_pre_start+settings.max_steps_self_start):
        ...
        #pygame.image.save(env[6], os.path.join(animation_path, "Frame{}.jpg".format(t)))
