...
def add_swing(space):
    ...
    #lrod_end.angle = -5*np.pi/180
    lrod_end.angular_velocity = -1
    ...
    space.add(urod, lrod, seat, swing_pivot, urod_end, lrod_end, swing_joint, middle_joint, middle_joint_lim)#, middle_joint_lim)
...
def stepper(space, urod_end, lrod_end, robot_body, robot_leg, body_motor, leg_motor, screen, draw_options, clock, font, body_motor_rate, leg_motor_rate, max_angle):
