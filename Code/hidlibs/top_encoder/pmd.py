...
pmd_serial = libpmd.pmd_serial ; pmd_serial.restype = c_char_p
...
pmd_version = libpmd.pmd_version ; pmd_version.restype = c_char_p
usb_get_errmsg = libpmd.usb_get_errmsg ; usb_get_errmsg.restype = c_char_p
...
class pmd1208fs:
    ...
    def ainscan(self, lowch=0, highch=0, npts=1000, interval=100, trigger=0, block=1):
