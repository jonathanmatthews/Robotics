...
class Robotcontrol():
    ...
    def extended_position(self):
        ...
        angle_names = [self.HP[0], self.RSR[0], self.LSR[0], self.RSP[0], self.LSP[0], self.REY[0], self.LEY[0], self.RER[0], self.LER[0], self.RHP[0], self.LHP[0], self.RKP[0], self.LKP[0], self.RWY[0], self.LWY[0], self.RH[0], self.LH[0]]
        angles =      [self.HP[1], self.RSR[1], self.LSR[1], self.RSP[1], self.LSP[1], self.REY[1], self.LEY[1], self.RER[1], self.LER[1], self.RHP[1], self.LHP[1], self.RKP[1], self.LKP[1], self.RWY[1], self.LWY[1], self.RH[1], self.LH[1]]
    ...
    def seated_position(self):
        ...
        parts =       ["Head", "RArm","LArm", "RLeg", "LLeg"]
        angle_names = [self.HP[0], self.RSR[0], self.LSR[0], self.RSP[0], self.LSP[0], self.REY[0], self.LEY[0], self.RER[0], self.LER[0], self.RHP[0], self.LHP[0], self.RKP[0], self.LKP[0], self.RWY[0], self.LWY[0], self.RH[0], self.LH[0]]
        angles =      [self.HP[3], self.RSR[3], self.LSR[3], self.RSP[3], self.LSP[3], self.REY[3], self.LEY[3], self.RER[3], self.LER[3], self.RHP[3], self.LHP[3], self.RKP[3], self.LKP[3], self.RWY[3], self.LWY[3], self.RH[3], self.LH[3]]
        #speed =       []
        self.move_part(self.motion, parts, angle_names, angles, 0.6, rest_time)
