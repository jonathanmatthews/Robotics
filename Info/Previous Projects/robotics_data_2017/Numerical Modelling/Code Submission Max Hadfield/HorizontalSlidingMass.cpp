...
//An early version of the Horizontal Sliding Mass simulation before movement analysis was performed
...
int main()
{
    ...
    double m1=2; //mass of sliding mass
    double m2=5; //mass of fixed mass
